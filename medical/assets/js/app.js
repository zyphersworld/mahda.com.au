...
(function () {
  ...
  "site": {
    ...
    "updated": "17 August 2026 — following the 15–16 August crisis",
    "default": "start"
  },
  "nav": [
    {
  ...
  "pages": {
    ...
    "current": {
      ...
      "title": "Right now",
      "lede": "The current picture as at 17 August 2026, including the crisis overnight 15–16 August.",
      "blocks": [
        {
          "type": "alert",
          "heading": "15–16 August — the most significant episode to date",
          "blocks": [
            {
              "type": "rows",
              "items": [
                {
                  "k": "Readings",
                  "v": "Sustained hypertensive crisis, roughly 198/128 down to 189/137 across 12+ hours, minimally responsive to medication already in the regimen."
                },
                {
                  "k": "Alongside",
                  "v": "Approximately 48 hours of dissociation and physical unsteadiness — constant, not intermittent, described as swaying/unsteady on my feet throughout."
                },
                {
                  "k": "Context",
                  "v": "Preceded by roughly two weeks of high-intensity, low-sleep parallel work across several projects at once. Spent the night of 15–16 August alone, overnight, in a church building — by choice, undisclosed in advance. Approximately four hours' sleep."
                },
                {
                  "k": "Disclosed",
                  "v": "Told my treating specialist directly that this is beyond what she alone can manage. She agreed. Referred to Jayce, Warrnambool Adult Mental Health Team, for a formal plan. Appointment pending."
                },
                {
                  "k": "Also raised",
                  "v": "Periods of memory gaps for my own recent actions, and weeks that felt fuzzy or dream-like — raised with my specialist as part of the same disclosure, being assessed rather than self-diagnosed."
                }
              ]
            },
            {
              "type": "callout",
              "text": "This episode is now the most clinically significant thing on this page. The 13 August entry below is kept as the prior episode, not superseded or retracted."
            }
          ]
        },
        {
          "type": "alert",
          "heading": "13 August, evening — earlier episode, same fortnight",
          "blocks": [
            {
              "type": "rows",
              "items": [
    ...
    "mental": {
      ...
      "blocks": [
          ...
          "blocks": [
            {
              ...
              "items": [
                ...
                {
                  "k": "Also relevant",
                  "v": "Ongoing grief connected to the end of a long-term caregiving role and relationship, not yet fully processed. Surfaced directly this week."
                },
                {
                  "k": "Current",
                  "v": "Managing an acute exacerbation. Overnight 15–16 August: a sustained hypertensive crisis and roughly 48 hours of dissociation and physical unsteadiness, following approximately two weeks of markedly high-intensity, low-sleep output across multiple concurrent projects."
                },
                {
                ...
                {
                  "k": "Memory",
                  "v": "Periods of memory gaps for my own recent actions — finding work I'd started with no recollection of starting it, alongside weeks that felt fuzzy or dream-like. Raised directly with my treating specialist and being assessed as part of the current referral. Not self-diagnosed; not settled."
                },
                {
                  "k": "Prior admissions",
        ...
        {
          "type": "panel",
          "heading": "Mental health plan — now in progress",
          "blocks": [
            {
              "type": "para",
              "text": "I disclosed the scale of what's been happening to my treating specialist directly on 16 August, and we agree a formal plan is needed. I've been referred back to Jayce at Warrnambool Adult Mental Health Team. Appointment pending — ask me or check with South West Healthcare for current status."
            },
            {
              "type": "rows",
              "items": [
                {
                  "k": "Why there wasn’t one until now",
          ...
          "blocks": [
            {
              ...
              "items": [
                ...
                "The output itself has a documented shape worth knowing: parallel project count across creative, technical, legal and advocacy work grew from roughly three concurrent threads in mid-June to eight from late July onward, with after-midnight working sessions clustering in the two highest-intensity weeks. The largest single piece of work in the whole period was completed on 15 August — the day before the crisis. That sequence is on record, not guessed at.",
                "I've also caught it myself, twice, before the crisis: paused a planned in-person meeting when I recognised I needed to slow down, and separately told my daughter directly I was managing something that meant taking things slowly. Worth knowing there's some retained self-awareness inside the pattern, not just the pattern itself."
              ]
            }
          ]
        },
